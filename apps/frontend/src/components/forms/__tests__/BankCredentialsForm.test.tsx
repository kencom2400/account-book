...
describe('BankCredentialsForm', () => {
  ...
  it('should render form with all fields', () => {
    ...
    expect(screen.getByLabelText(/銀行コード/)).toBeInTheDocument();
    expect(screen.getByLabelText(/支店コード/)).toBeInTheDocument();
    expect(screen.getByLabelText(/口座番号/)).toBeInTheDocument();
    expect(screen.getByLabelText(/APIキー/)).toBeInTheDocument();
    expect(screen.getByLabelText(/APIシークレット/)).toBeInTheDocument();
  });
  ...
  it('should pre-fill bank code', () => {
    ...
    const bankCodeInput = screen.getByLabelText(
      /銀行コード/,
    ) as HTMLInputElement;
  ...
  it('should validate branch code format', async () => {
    ...
    const branchCodeInput = screen.getByLabelText(/支店コード/);
  ...
  it('should include optional API credentials', async () => {
    ...
    const apiSecretInput = screen.getByLabelText(/APIシークレット/);
    const submitButton = screen.getByText('接続テスト');
  ...
  it('should toggle API secret visibility', () => {
    ...
    const apiSecretInput = screen.getByLabelText(
      /APIシークレット/,
    ) as HTMLInputElement;
